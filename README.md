...
| Programmes | 19 staged policy packages |
...
src/addons/    v4…v15-addon.js         each version's new behaviour, layered by wrapping functions
src/build/     build-v4…v15.py         exact-string patch scripts, one per version
src/data/      map polygons, city catalogue, provenance notes
tests/         check-game…check-v15.cjs   engine invariants, run in a vm sandbox
dist/          sovereign-v15.html      the built game
...
python3 src/build/build-v14.py   # federal agencies, country selection
python3 src/build/build-v15.py   # funded budgets, ten reforms, build in all cities  -> dist/
